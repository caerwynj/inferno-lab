...
title_cfg := array[] of {
	"button .Wm_br -relief flat -fg olive -bg olive -activebackground olive -activeforeground olive -highlightcolor olive -width 1",
	"button .Wm_bl -relief flat -fg olive -bg olive -activebackground olive -activeforeground olive -highlightcolor olive -width 1",
	"button .Wm_bb -relief flat -fg olive -bg olive -activebackground olive -activeforeground olive -highlightcolor olive -height 1",
	"button .Wm_bt -relief flat -fg olive -bg olive -activebackground olive -activeforeground olive -highlightcolor olive -height 1",
...
title(nil: ref Tk->Toplevel): string
{
	return nil;
}
	
settitle(top: ref Tk->Toplevel, nil: string): string
{
	s := title(top);
