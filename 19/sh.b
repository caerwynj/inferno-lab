...
shwin_cfg := array[] of {
	...
	"frame .ft -bd 0",
	"scrollbar .ft.scroll -width 14 -borderwidth 0 -relief flat -command {.ft.t yview}",
	"text .ft.t -bd 1 -relief flat -yscrollcommand {.ft.scroll set} -bg white -selectforeground black -selectbackground #CCCCCC",
